...
@Component("checkLastAccount")
public class CheckLastAccount implements JavaDelegate {

    private final AccountService accountService;

    public CheckLastAccount(AccountService accountService) {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        accountRequest.setIban(request.getLastAccountIban());
        Account lastAccount = accountService.checkUpAccount(accountRequest);
        execution.setVariable("lastAccount",lastAccount);
    }
}
